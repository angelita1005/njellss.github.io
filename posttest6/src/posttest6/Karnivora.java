...
public class Karnivora extends Data implements Hewan {

    private String jenishewan;
    private String jumlah_kaki;
    
    public Karnivora(String nama, String tanggalAdopsi, int tinggi, int berat, String jenishewan, String jumlah_kaki){
